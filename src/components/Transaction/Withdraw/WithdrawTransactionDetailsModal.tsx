...
export const WithdrawTransactionDetailsModal = ({
  open,
  toggle,
  id,
}: Props) => {
            ...
            <Box mb={3}>
              ...
              <Box>
                ...
                <Typography component="span">
                  {data.salesman.firstName + " " + data.salesman.lastName}
                </Typography>
              </Box>
              <Box>
                <Typography component="span" fontWeight="bold">
                ...
                <Typography component="span">
                  {data.warehouse_incharge.firstName +
                    " " +
                    data.warehouse_incharge.lastName}
                </Typography>
              </Box>
